...
struct GuiSelection {
    ...
    void selectSource(int sourceId) { type = sourceId == 0 ? GuiObjectType::None : GuiObjectType::Source; id = sourceId; }
    void selectReceiver(int receiverId) { type = receiverId == 0 ? GuiObjectType::None : GuiObjectType::Receiver; id = receiverId; }
