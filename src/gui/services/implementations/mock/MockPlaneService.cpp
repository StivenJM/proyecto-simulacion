...
{
    addPlane(scenario, selection, {0.0f, -2.0f, 0.0f}, 4.0f, 4.0f, PlaneOrientation::Horizontal);
    addPlane(scenario, selection, {0.0f, 2.0f, 0.0f}, 4.0f, 4.0f, PlaneOrientation::Horizontal);
    addPlane(scenario, selection, {-2.0f, 0.0f, 0.0f}, 4.0f, 4.0f, PlaneOrientation::VerticalX);
    addPlane(scenario, selection, {2.0f, 0.0f, 0.0f}, 4.0f, 4.0f, PlaneOrientation::VerticalX);
    addPlane(scenario, selection, {0.0f, 0.0f, -2.0f}, 4.0f, 4.0f, PlaneOrientation::VerticalZ);
    addPlane(scenario, selection, {0.0f, 0.0f, 2.0f}, 4.0f, 4.0f, PlaneOrientation::VerticalZ);
}
