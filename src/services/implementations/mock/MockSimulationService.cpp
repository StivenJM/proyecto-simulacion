...
SimulationResult MockSimulationService::runSimulation(
    ...
    // Rayos de reflexión falsos pero coherentes para probar visualización
    ...
    // Energía en receptores (usa IDs del escenario si existen, si no usa 0)
    ...
    // Matriz de difusión mínima (2 triángulos visibles entre sí)
